...
- 只使用 `polling` 传输
- 不要启用 websocket transport upgrade

原因：

- 当前 Emosonic Server 的开发态运行方式是 Flask/Werkzeug + Socket.IO threading
- 在这个模式下，polling 稳定可用
- websocket transport upgrade 可能触发 500 错误
